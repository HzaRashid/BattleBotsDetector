...
This architectural shift is motivated by modern methods such as \textit{``Multimodal Detection of Bots on X (Twitter) using
...
model user behaviour in novel way given the restrictions of the features available to us, and multimodal interactions
