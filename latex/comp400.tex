...
\begin{itemize}
    ...
    related continuous features like embeddings can introduce noise. To utilize such features effectively, it would be more
    approriate to employ an MLP (multi-layered perceptron).
    % In addition, the increased feature dimensionality likely contributed to further noise.
...
our model relied on many static features (e.g., mean and standard deviation of time between posts), which
are also prone manipulation.
Thus, the observed manipulation and diminishing returns on feature engineering
