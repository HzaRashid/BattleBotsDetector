...
def process_data():
    ...
    X_train_tfidf = tfidf_vectorizer.fit_transform(X_train_text.fillna(""))
    X_test_tfidf = tfidf_vectorizer.transform(X_test_text.fillna(""))
    ...
    X_train_combined = np.hstack((X_train_tfidf.toarray(), X_train_lda))
    X_test_combined = np.hstack((X_test_tfidf.toarray(), X_test_lda))
